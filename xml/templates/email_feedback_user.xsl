...
<html>
<head>
	<title>Оповещение пользователя с сайта <xsl:value-of select="/email/@name" /></title>
		...
		<tbody>
			<tr>
				...
				<td colspan="4"><table width="100%" style="width:100%;border-collapse:collapse;border-width:1px; border-style:solid; border-color:#fff; margin-bottom:20px;"><tbody>
					<caption><p style="margin:0; padding:0;"><h1>Сообщение формы обратной связи</h1></p></caption>
					<tr><td colspan="2"><p style="margin:0; padding:0;">Ваша заявка была успешно отправлена и принята в обработку. В скором времени вам обязательно ответят по электронной почте или телефону, указанными вами при составлении запроса.</p></td></tr>
				</tbody></table></td>
				<td style="border:0; vertical-align:middle;"><p style="margin:0; padding:0;"><xsl:call-template name="nbsp" /></p></td>
			</tr>
			<tr>
			...
			<tr><td colspan="4">
				<p style="margin:0; padding:0;">Письмо отправленно автоматически и не требует ответа</p>
			</td></tr>
		</tbody>
	</table>	
</xsl:template>
